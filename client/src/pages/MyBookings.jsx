...
const MyBookings = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            toast.error('Login to visit My Bookings Page')
            navigate('/')
        }
    }, [user])
                    ...
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
                        ...
                        <div className='md:col-span-1'>
                            <div className='rounded-md overflow-hidden mb-3'>
                                <img src={booking.car.image} className='w-full h-auto aspect-video object-cover' alt={booking.car.brand + booking.car.model} />
                            </div>
                        ...
                        <div className='md:col-span-1 flex flex-col justify-between gap-6'>
                            <div className='text-sm text-gray-500 text-right'>
                                ...
                                <h1 className='text-2xl font-semibold text-primary'>{currency}-{booking.pricePerDay}</h1>
